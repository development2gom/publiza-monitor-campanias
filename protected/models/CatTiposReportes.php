...
/**
 * This is the model class for table "cat_tipos_reportes".
 *
 * The followings are the available columns in table 'cat_tipos_reportes':
 ...
 */
class CatTiposReportes extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_tipo_reporte, txt_nombre, txt_desc, b_habilitado', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'wrkReportes' => array(self::HAS_MANY, 'WrkReporte', 'id_tipo_reporte'),
		);
	}
	 ...
	 * @return CatTiposReportes the static model class
	 */

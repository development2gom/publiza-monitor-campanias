 ...
 */
class WrkEvidencia extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('image', 'file', 'types'=>'jpg, gif, png', 'safe' => false,'on'=>'web'), //Escenario WEB, permite que la foto solo sea requerida si es web
		);
	}
	...
	public function getImagenUrl(){
		return '<img src="' . $this->txt_url_imagen . '">';
	}
}
